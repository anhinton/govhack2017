...
<!-- ![map of intersection of Karangahape and Newton Roads, Auckland](images/intersectionMap.png) -->
...
crashLocation = sort(table(as.character(intersectionData$crash_locn1)))

opar = par(mar = c(5.1, 12.1, 4.1, 2.1))
barplot(
    height = crashLocation,
    horiz = TRUE,
    las = 1,
    main = "Crashes by main location")
par(opar)
